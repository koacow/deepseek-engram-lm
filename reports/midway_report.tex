...
simplify the multi-branch residual stream, which prior work has shown to be a key driver of Engram's performance (Larsson et al., 2017; Szegedy et al., 2015; Xie et al., 2025; Zhu et al., 2025), to a single branch. Finally,
...
\paragraph{Compared model variants.}
...
With the training loop implemented and initial experiments underway, our next steps are to analyze validation perplexity trends across the three model variants, perform final test-set evaluation, 
